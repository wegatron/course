...
int main(int argc, char **argv)
{
    ...
    std::string VertexPath = "/media/wegatron/data/workspace/zsw_work/projects/lidar_slam_course/HW6/LSSLAMProject/src/ls_slam/data/killian-v.dat";
    std::string EdgePath = "/media/wegatron/data/workspace/zsw_work/projects/lidar_slam_course/HW6/LSSLAMProject/src/ls_slam/data/killian-e.dat";

    // std::string VertexPath = "/media/wegatron/data/workspace/zsw_work/projects/lidar_slam_course/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-v.dat";
    // std::string EdgePath = "/media/wegatron/data/workspace/zsw_work/projects/lidar_slam_course/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-e.dat";
...
//    std::string EdgePath = "/home/eventec/LSSLAMProject/src/ls_slam/data/intel-e.dat";
    ...
    for(int i = 0; i < maxIteration;i++)
    {
        ...
        Eigen::VectorXd dx = pa6_gn::LinearizeAndSolve(Vertexs,Edges);

        //进行更新
        //TODO--Start
        for(int j=0; j<Vertexs.size(); ++j)
        {
            Vertexs[j] += dx.block<3,1>(3*j, 0);
        }
        //TODO--End
    ...
    std::cout << "TimeCost:" << std::chrono::duration_cast<std::chrono::microseconds>(tp1-tp0).count()
