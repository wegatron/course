...
def main():
    points, faces = read_off('/media/wegatron/data/data/ModelNet/data/airplane_0001.off')
    export_ply(points, '/media/wegatron/data/data/ModelNet/data/airplane_0001.ply')
    # # ply目标文件产生路径
