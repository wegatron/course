...
int main(int argc, char** argv)
{
	...
	= zsw_gz_common::load_laser3d_frame("F:/data/3d-data/wangjinyi/map/Node3DDir-20181017T170336/LASER3D_0_0.bin");
	...
	//ne.computeFeature(*cloud_normals);
	ne.compute(*cloud_normals);

	pcl::visualization::PCLVisualizer::Ptr viewer;
	viewer = normalsVis(point_cloud_ptr, cloud_normals);
	zsw::point_cloud2vtk_file("f:/with_normal.vtk", point_cloud_ptr, {}, cloud_normals);
